...
context "Metric" do
  ...
  context "tracking" do
    test "can count" do
      ...
      # In disconnected mode, none of the metrics are tracked.
      assert_nil yawns
      assert_nil cheers
    end
    ...
    test "with no value" do
      ...
      # In disconnected mode, none of the metrics are tracked so value
      # comes back as zero.
      assert_equal 0, Vanity.playground.metric(:looks).values(today, today).sum
    end
    ...
    test "destroy wipes metrics" do
      ...
      # In disconnected mode, none of the metrics are tracked.
      assert_equal [], Vanity.playground.metric(:many_happy_returns).values(today, today)
  ...
  context "created_at" do
    ...
    test "across restarts" do
      ...
      Timecop.travel past do
        ...
        # created_at is not set in disconnected mode
        assert_nil coolness.created_at
      end
      ...
      # created_at is not set in disconnected mode
      assert_nil new_cool.created_at
    end
  end 
  ...
  context "data" do
    test "explicit dates" do
      ...
      assert_equal [[today - 5, nil], [today - 4, nil], [today - 3, nil], [today - 2, nil], [today - 1, nil], [today, nil]], boredom
    end
    ...
    test "start date only" do
      ...
      assert_equal [[today - 4, nil], [today - 3, nil], [today - 2, nil], [today - 1, nil], [today, nil]], boredom
    end
    ...
    test "no data" do
      ...
      assert_equal [today - 89, nil], boredom.first
      assert_equal [today, nil], boredom.last
    end
  ...
  context "ActiveRecord" do
    ...
    test "do it youself" do
      ...
      # In disconnected mode, none of the metrics are recorded so this
      # result is nil.
      assert_nil Vanity::Metric.data(metric(:sky_is_limit)).last.last
    end
